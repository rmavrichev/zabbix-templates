...
speed = total_speed.get("Core",default)
...
tstmp = ZBXSENDER + ' -z ' + ZBXSERVER + ' -s ' + ZBXHOST + ' -k PrcrCore.tstamp -o ' + TSTAMP
valdl = ZBXSENDER + ' -z ' + ZBXSERVER + ' -s ' + ZBXHOST + ' -k PrcrCore.val_dl -o ' + VAL_DL
valul = ZBXSENDER + ' -z ' + ZBXSERVER + ' -s ' + ZBXHOST + ' -k PrcrCore.val_ul -o ' + VAL_UL
